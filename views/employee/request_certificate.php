...
<div class="lg:ml-64">
    <div class="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold <?php echo $text_class; ?> mt-2">Request Certificate</h1>
        ...
        <div class="<?php echo $card_bg; ?> rounded-lg shadow-lg p-6">
            <form method="POST" action="" id="certForm">
                ...
                <div class="<?php echo $is_dark ? 'bg-gray-700' : 'bg-blue-50'; ?> rounded-lg p-4 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="<?php echo get_master('position_master', $employee['position_id']); ?>
                            " readonly
                                class="w-full px-3 py-2 <?php echo $is_dark ? 'bg-gray-600 border-gray-500 text-gray-200' : 'bg-white border-blue-200 text-gray-700'; ?> border rounded cursor-not-allowed">
                        </div>
                        <div>
                ...
                <!-- Purpose -->
                <div class="mb-6">
                    <label for="purpose" class="block text-sm font-medium <?php echo $text_class; ?> mb-2">
                ...
                <!-- Certificate Preview -->
                <div class="mb-6 p-4 <?php echo $is_dark ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'; ?> border rounded-lg">
                    <h4 class="font-semibold <?php echo $text_class; ?> mb-2 flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        Certificate Preview
                    </h4>
                    <p class="text-sm <?php echo $is_dark ? 'text-gray-300' : 'text-gray-600'; ?>">
                        This certificate will include:
                    </p>
                    <ul class="text-sm <?php echo $is_dark ? 'text-gray-400' : 'text-gray-500'; ?> mt-2 list-disc list-inside space-y-1">
