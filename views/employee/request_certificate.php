...
$translations = [
    'th' => [
        ...
        'purpose_placeholder' => 'ระบุวัตถุประสงค์ในการขอหนังสือรับรอง',
        'submit_request' => 'ส่งคำขอ',
        'cancel' => 'ยกเลิก',
    ],
    'en' => [
        'page_title' => 'Request Certificate',
        'page_subtitle' => 'Submit your certificate request',
        ...
        'no_types_available' => 'No certificate types available',
        'purpose' => 'Purpose',
        'purpose_placeholder' => 'Specify the purpose for this certificate',
        'submit_request' => 'Submit Request',
        'cancel' => 'Cancel',
    ],
    'my' => [
        'page_title' => 'လက်မှတ်တောင်းခံ',
        'page_subtitle' => 'လက်မှတ်တောင်းခံမှုတင်သွင်းမည်',
        ...
        'purpose' => 'ရည်ရွယ်ချက်',
        'purpose_placeholder' => 'လက်မှတ်တောင်းခံရန်ရည်ရွယ်ချက်',
...
// ✅ FIXED: Only close connection if not already closed
