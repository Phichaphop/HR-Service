...
<aside id="sidebar" class="fixed top-0 left-0 h-full w-64 <?php echo $sidebar_bg; ?> <?php echo $sidebar_text; ?> transform -translate-x-full lg:translate-x-0 transition-transform duration-300 z-50 overflow-y-auto shadow-2xl">
    <div class="p-6">
        ...
        <nav class="space-y-1">
            ...
            <!-- Certificate Types (Admin) -->
            <?php if ($user_role === 'admin'): ?>
                <a href="<?php echo BASE_PATH; ?>/views/admin/certificate_types.php"
                    class="flex items-center px-4 py-3 rounded-lg hover:bg-white hover:bg-opacity-20 transition group">
            ...
            <!-- Document Delivery (Admin/Officer) -->
            <?php if (in_array($user_role, ['admin', 'officer'])): ?>
                <a href="<?php echo BASE_PATH; ?>/views/admin/document_delivery_list.php"
                    class="flex items-center px-4 py-3 rounded-lg hover:bg-white hover:bg-opacity-20 transition group">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
                    <span>Manage Doc Delivery</span>
                </a>
            <?php endif; ?>
